...
describe('Testing Other Endpoints', () => {
    ...
    describe('it should fetch landing page', () => {
        it('it should return index.html', (done) => {
          chai.request(server)
              .get('/')
              .end((err, res) => {
                    res.should.have.status(200);
                    res.text.should.include('SOLAR');
                done();
              });
        });
    });

    describe('it should return not found for an unknown planet', () => {
        it('it should reject ids outside the supported range', (done) => {
            let payload = {
                id: 999
            };
          chai.request(server)
